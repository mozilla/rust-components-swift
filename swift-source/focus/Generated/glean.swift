...
private extension RustBuffer {
    ...
    static func from(_ ptr: UnsafeBufferPointer<UInt8>) -> RustBuffer {
        try! rustCall { ffi_glean_7074_rustbuffer_from_bytes(ForeignBytes(bufferPointer: ptr), $0) }
    }

    // Frees the buffer in place.
    // The buffer must not be used after this is called.
    func deallocate() {
        try! rustCall { ffi_glean_7074_rustbuffer_free(self, $0) }
    }
}
...
public func gleanEnableLogging() {
    try!
        ...
        rustCall {
            glean_7074_glean_enable_logging($0)
        }
}
...
public func gleanEnableLoggingToFd(_ fd: UInt64) {
    try!
        ...
        rustCall {
            glean_7074_glean_enable_logging_to_fd(
...
public func gleanInitializeForSubprocess(_ cfg: InternalConfiguration) -> Bool {
    return try! FfiConverterBool.lift(
        try!
            ...
            rustCall {
                glean_7074_glean_initialize_for_subprocess(
...
public func gleanSetUploadEnabled(_ enabled: Bool) {
    try!
        ...
        rustCall {
            glean_7074_glean_set_upload_enabled(
...
public func gleanSetExperimentActive(_ experimentId: String, _ branch: String, _ extra: [String: String]) {
    try!
        ...
        rustCall {
            glean_7074_glean_set_experiment_active(
...
public func gleanSetExperimentInactive(_ experimentId: String) {
    try!
        ...
        rustCall {
            glean_7074_glean_set_experiment_inactive(
...
public func gleanTestGetExperimentData(_ experimentId: String) -> RecordedExperiment? {
    return try! FfiConverterOptionTypeRecordedExperiment.lift(
        try!
            ...
            rustCall {
                glean_7074_glean_test_get_experiment_data(
                    FfiConverterString.lower(experimentId), $0
                )
            }
    )
...
public func gleanSetDebugViewTag(_ tag: String) -> Bool {
    return try! FfiConverterBool.lift(
        try!
            ...
            rustCall {
                glean_7074_glean_set_debug_view_tag(
...
public func gleanSetSourceTags(_ tags: [String]) -> Bool {
    return try! FfiConverterBool.lift(
        try!
            ...
            rustCall {
                glean_7074_glean_set_source_tags(
...
public func gleanSetLogPings(_ value: Bool) {
    try!
        ...
        rustCall {
            glean_7074_glean_set_log_pings(
...
public func gleanHandleClientActive() {
    try!
        ...
        rustCall {
            glean_7074_glean_handle_client_active($0)
        }
}
...
public func gleanHandleClientInactive() {
    try!
        ...
        rustCall {
            glean_7074_glean_handle_client_inactive($0)
        }
}
...
public func gleanSubmitPingByName(_ pingName: String, _ reason: String? = nil) {
    try!
        ...
        rustCall {
            glean_7074_glean_submit_ping_by_name(
...
public func gleanSubmitPingByNameSync(_ pingName: String, _ reason: String? = nil) -> Bool {
    return try! FfiConverterBool.lift(
        try!
            ...
            rustCall {
                glean_7074_glean_submit_ping_by_name_sync(
                    FfiConverterString.lower(pingName),
                    FfiConverterOptionString.lower(reason), $0
                )
            }
...
public func gleanSetTestMode(_ enabled: Bool) {
    try!
        ...
        rustCall {
            glean_7074_glean_set_test_mode(
                FfiConverterBool.lower(enabled), $0
            )
        }
}
...
public func gleanTestDestroyGlean(_ clearStores: Bool) {
    try!
        ...
        rustCall {
            glean_7074_glean_test_destroy_glean(
...
public func gleanSetDirtyFlag(_ flag: Bool) {
    try!
        ...
        rustCall {
            glean_7074_glean_set_dirty_flag(
...
public func gleanGetUploadTask() -> PingUploadTask {
    return try! FfiConverterTypePingUploadTask.lift(
        try!
            ...
            rustCall {
                glean_7074_glean_get_upload_task($0)
            }
    )
}

public func gleanProcessPingUploadResponse(_ uuid: String, _ result: UploadResult) {
    try!

        rustCall {
            glean_7074_glean_process_ping_upload_response(
...
public class PingType: PingTypeProtocol {
    ...
    deinit {
        try! rustCall { ffi_glean_7074_PingType_object_free(pointer, $0) }
    }

    public func submit(_ reason: String? = nil) {
        try!
            rustCall {
                glean_7074_PingType_submit(self.pointer,
                                           FfiConverterOptionString.lower(reason), $0)
            }
    }
}
...
public protocol CounterMetricProtocol {
    ...
    func testGetNumRecordedErrors(_ error: ErrorType, _ pingName: String?) -> Int32
}
...
public class CounterMetric: CounterMetricProtocol {
    ...
    deinit {
        try! rustCall { ffi_glean_7074_CounterMetric_object_free(pointer, $0) }
    }

    public func add(_ amount: Int32 = 1) {
        try!
            rustCall {
                glean_7074_CounterMetric_add(self.pointer,
    ...
    public func testGetValue(_ pingName: String? = nil) -> Int32? {
        return try! FfiConverterOptionInt32.lift(
            try!
                rustCall {
                    glean_7074_CounterMetric_test_get_value(self.pointer,
                                                            FfiConverterOptionString.lower(pingName), $0)
                }
        )
    }

    public func testGetNumRecordedErrors(_ error: ErrorType, _ pingName: String? = nil) -> Int32 {
        return try! FfiConverterInt32.lift(
            try!
                rustCall {
                    glean_7074_CounterMetric_test_get_num_recorded_errors(self.pointer,
...
public class TimespanMetric: TimespanMetricProtocol {
    ...
    deinit {
        try! rustCall { ffi_glean_7074_TimespanMetric_object_free(pointer, $0) }
    }

    public func start() {
        try!
            rustCall {
                glean_7074_TimespanMetric_start(self.pointer, $0)
            }
    }
    ...
    public func stop() {
        try!
            rustCall {
                glean_7074_TimespanMetric_stop(self.pointer, $0)
            }
    }
    ...
    public func cancel() {
        try!
            rustCall {
                glean_7074_TimespanMetric_cancel(self.pointer, $0)
            }
    }
    ...
    public func setRawNanos(_ elapsed: Int64) {
        try!
            rustCall {
                glean_7074_TimespanMetric_set_raw_nanos(self.pointer,
    ...
    public func testGetValue(_ pingName: String? = nil) -> Int64? {
        return try! FfiConverterOptionInt64.lift(
            try!
                rustCall {
                    glean_7074_TimespanMetric_test_get_value(self.pointer,
                                                             FfiConverterOptionString.lower(pingName), $0)
                }
        )
    }
    ...
    public func testGetNumRecordedErrors(_ error: ErrorType, _ pingName: String? = nil) -> Int32 {
        return try! FfiConverterInt32.lift(
            try!
                rustCall {
                    glean_7074_TimespanMetric_test_get_num_recorded_errors(self.pointer,
                                                                           FfiConverterTypeErrorType.lower(error),
                                                                           FfiConverterOptionString.lower(pingName), $0)
                }
        )
...
public class BooleanMetric: BooleanMetricProtocol {
    ...
    deinit {
        try! rustCall { ffi_glean_7074_BooleanMetric_object_free(pointer, $0) }
    }

    public func set(_ value: Bool) {
        try!
            rustCall {
                glean_7074_BooleanMetric_set(self.pointer,
                                             FfiConverterBool.lower(value), $0)
            }
    }
    ...
    public func testGetValue(_ pingName: String? = nil) -> Bool? {
        return try! FfiConverterOptionBool.lift(
            try!
                rustCall {
                    glean_7074_BooleanMetric_test_get_value(self.pointer,
                                                            FfiConverterOptionString.lower(pingName), $0)
                }
        )
    }
    ...
    public func testGetNumRecordedErrors(_ error: ErrorType, _ pingName: String? = nil) -> Int32 {
        return try! FfiConverterInt32.lift(
            try!
                rustCall {
                    glean_7074_BooleanMetric_test_get_num_recorded_errors(self.pointer,
                                                                          FfiConverterTypeErrorType.lower(error),
                                                                          FfiConverterOptionString.lower(pingName), $0)
                }
        )
...
public class StringMetric: StringMetricProtocol {
    ...
    deinit {
        try! rustCall { ffi_glean_7074_StringMetric_object_free(pointer, $0) }
    }

    public func set(_ value: String) {
        try!
            rustCall {
                glean_7074_StringMetric_set(self.pointer,
    ...
    public func testGetValue(_ pingName: String? = nil) -> String? {
        return try! FfiConverterOptionString.lift(
            try!
                rustCall {
                    glean_7074_StringMetric_test_get_value(self.pointer,
                                                           FfiConverterOptionString.lower(pingName), $0)
                }
        )
    }
    ...
    public func testGetNumRecordedErrors(_ error: ErrorType, _ pingName: String? = nil) -> Int32 {
        return try! FfiConverterInt32.lift(
            try!
                rustCall {
                    glean_7074_StringMetric_test_get_num_recorded_errors(self.pointer,
                                                                         FfiConverterTypeErrorType.lower(error),
                                                                         FfiConverterOptionString.lower(pingName), $0)
                }
        )
...
public class LabeledCounter: LabeledCounterProtocol {
    ...
    deinit {
        try! rustCall { ffi_glean_7074_LabeledCounter_object_free(pointer, $0) }
    }
    ...
    public func get(_ label: String) -> CounterMetric {
        return try! FfiConverterTypeCounterMetric.lift(
            try!
                rustCall {
                    glean_7074_LabeledCounter_get(self.pointer,
    ...
    public func testGetNumRecordedErrors(_ error: ErrorType, _ pingName: String? = nil) -> Int32 {
        return try! FfiConverterInt32.lift(
            try!
                rustCall {
                    glean_7074_LabeledCounter_test_get_num_recorded_errors(self.pointer,
                                                                           FfiConverterTypeErrorType.lower(error),
                                                                           FfiConverterOptionString.lower(pingName), $0)
                }
        )
...
public class LabeledBoolean: LabeledBooleanProtocol {
    ...
    deinit {
        try! rustCall { ffi_glean_7074_LabeledBoolean_object_free(pointer, $0) }
    }
    ...
    public func get(_ label: String) -> BooleanMetric {
        return try! FfiConverterTypeBooleanMetric.lift(
            try!
                rustCall {
                    glean_7074_LabeledBoolean_get(self.pointer,
                                                  FfiConverterString.lower(label), $0)
                }
        )
    }
    ...
    public func testGetNumRecordedErrors(_ error: ErrorType, _ pingName: String? = nil) -> Int32 {
        return try! FfiConverterInt32.lift(
            try!
                rustCall {
                    glean_7074_LabeledBoolean_test_get_num_recorded_errors(self.pointer,
                                                                           FfiConverterTypeErrorType.lower(error),
                                                                           FfiConverterOptionString.lower(pingName), $0)
                }
        )
...
public class LabeledString: LabeledStringProtocol {
    ...
    deinit {
        try! rustCall { ffi_glean_7074_LabeledString_object_free(pointer, $0) }
    }
    ...
    public func get(_ label: String) -> StringMetric {
        return try! FfiConverterTypeStringMetric.lift(
            try!
                rustCall {
                    glean_7074_LabeledString_get(self.pointer,
                                                 FfiConverterString.lower(label), $0)
                }
        )
    }
    ...
    public func testGetNumRecordedErrors(_ error: ErrorType, _ pingName: String? = nil) -> Int32 {
        return try! FfiConverterInt32.lift(
            try!
                rustCall {
                    glean_7074_LabeledString_test_get_num_recorded_errors(self.pointer,
                                                                          FfiConverterTypeErrorType.lower(error),
                                                                          FfiConverterOptionString.lower(pingName), $0)
                }
        )
...
public class StringListMetric: StringListMetricProtocol {
    ...
    public convenience init(_ meta: CommonMetricData) {
        self.init(unsafeFromRawPointer: try!
            ...
            rustCall {
                glean_7074_StringListMetric_new(
                    FfiConverterTypeCommonMetricData.lower(meta), $0
                )
            })
    }
    ...
    deinit {
        try! rustCall { ffi_glean_7074_StringListMetric_object_free(pointer, $0) }
    }

    public func add(_ value: String) {
        try!
            rustCall {
                glean_7074_StringListMetric_add(self.pointer,
                                                FfiConverterString.lower(value), $0)
            }
    }
    ...
    public func set(_ value: [String]) {
        try!
            rustCall {
                glean_7074_StringListMetric_set(self.pointer,
    ...
    public func testGetValue(_ pingName: String? = nil) -> [String]? {
        return try! FfiConverterOptionSequenceString.lift(
            try!
                rustCall {
                    glean_7074_StringListMetric_test_get_value(self.pointer,
                                                               FfiConverterOptionString.lower(pingName), $0)
                }
        )
    }
    ...
    public func testGetNumRecordedErrors(_ error: ErrorType, _ pingName: String? = nil) -> Int32 {
        return try! FfiConverterInt32.lift(
            try!
                rustCall {
                    glean_7074_StringListMetric_test_get_num_recorded_errors(self.pointer,
                                                                             FfiConverterTypeErrorType.lower(error),
                                                                             FfiConverterOptionString.lower(pingName), $0)
                }
        )
...
public class UrlMetric: UrlMetricProtocol {
    ...
    deinit {
        try! rustCall { ffi_glean_7074_UrlMetric_object_free(pointer, $0) }
    }

    public func set(_ value: String) {
        try!
            rustCall {
                glean_7074_UrlMetric_set(self.pointer,
                                         FfiConverterString.lower(value), $0)
            }
    }
    ...
    public func testGetValue(_ pingName: String? = nil) -> String? {
        return try! FfiConverterOptionString.lift(
            try!
                rustCall {
                    glean_7074_UrlMetric_test_get_value(self.pointer,
                                                        FfiConverterOptionString.lower(pingName), $0)
                }
        )
    }
    ...
    public func testGetNumRecordedErrors(_ error: ErrorType, _ pingName: String? = nil) -> Int32 {
        return try! FfiConverterInt32.lift(
            try!
                rustCall {
                    glean_7074_UrlMetric_test_get_num_recorded_errors(self.pointer,
                                                                      FfiConverterTypeErrorType.lower(error),
                                                                      FfiConverterOptionString.lower(pingName), $0)
                }
        )
...
public class UuidMetric: UuidMetricProtocol {
    ...
    deinit {
        try! rustCall { ffi_glean_7074_UuidMetric_object_free(pointer, $0) }
    }

    public func set(_ value: String) {
        try!
            rustCall {
                glean_7074_UuidMetric_set(self.pointer,
                                          FfiConverterString.lower(value), $0)
            }
    }
    ...
    public func generateAndSet() -> String {
        return try! FfiConverterString.lift(
            try!
                rustCall {
                    glean_7074_UuidMetric_generate_and_set(self.pointer, $0)
                }
        )
    }
    ...
    public func testGetValue(_ pingName: String? = nil) -> String? {
        return try! FfiConverterOptionString.lift(
            try!
                rustCall {
                    glean_7074_UuidMetric_test_get_value(self.pointer,
                                                         FfiConverterOptionString.lower(pingName), $0)
                }
        )
    }
    ...
    public func testGetNumRecordedErrors(_ error: ErrorType, _ pingName: String? = nil) -> Int32 {
        return try! FfiConverterInt32.lift(
            try!
                rustCall {
                    glean_7074_UuidMetric_test_get_num_recorded_errors(self.pointer,
                                                                       FfiConverterTypeErrorType.lower(error),
                                                                       FfiConverterOptionString.lower(pingName), $0)
                }
        )
...
public class QuantityMetric: QuantityMetricProtocol {
    ...
    deinit {
        try! rustCall { ffi_glean_7074_QuantityMetric_object_free(pointer, $0) }
    }

    public func set(_ value: Int64) {
        try!
            rustCall {
                glean_7074_QuantityMetric_set(self.pointer,
    ...
    public func testGetValue(_ pingName: String? = nil) -> Int64? {
        return try! FfiConverterOptionInt64.lift(
            try!
                rustCall {
                    glean_7074_QuantityMetric_test_get_value(self.pointer,
                                                             FfiConverterOptionString.lower(pingName), $0)
                }
        )
    }
    ...
    public func testGetNumRecordedErrors(_ error: ErrorType, _ pingName: String? = nil) -> Int32 {
        return try! FfiConverterInt32.lift(
            try!
                rustCall {
                    glean_7074_QuantityMetric_test_get_num_recorded_errors(self.pointer,
                                                                           FfiConverterTypeErrorType.lower(error),
                                                                           FfiConverterOptionString.lower(pingName), $0)
                }
        )
...
public class TimingDistributionMetric: TimingDistributionMetricProtocol {
    ...
    public convenience init(_ meta: CommonMetricData, _ timeUnit: TimeUnit) {
        self.init(unsafeFromRawPointer: try!
            ...
            rustCall {
                glean_7074_TimingDistributionMetric_new(
                    FfiConverterTypeCommonMetricData.lower(meta),
                    FfiConverterTypeTimeUnit.lower(timeUnit), $0
                )
            })
    ...
    deinit {
        try! rustCall { ffi_glean_7074_TimingDistributionMetric_object_free(pointer, $0) }
    }
    ...
    public func start() -> TimerId {
        return try! FfiConverterTypeTimerId.lift(
            try!
                rustCall {
                    glean_7074_TimingDistributionMetric_start(self.pointer, $0)
                }
        )
    }
    ...
    public func stopAndAccumulate(_ timerId: TimerId) {
        try!
            rustCall {
                glean_7074_TimingDistributionMetric_stop_and_accumulate(self.pointer,
    ...
    public func cancel(_ timerId: TimerId) {
        try!
            rustCall {
                glean_7074_TimingDistributionMetric_cancel(self.pointer,
                                                           FfiConverterTypeTimerId.lower(timerId), $0)
            }
    }
    ...
    public func accumulateSamples(_ samples: [Int64]) {
        try!
            rustCall {
                glean_7074_TimingDistributionMetric_accumulate_samples(self.pointer,
    ...
    public func testGetValue(_ pingName: String? = nil) -> DistributionData? {
        return try! FfiConverterOptionTypeDistributionData.lift(
            try!
                rustCall {
                    glean_7074_TimingDistributionMetric_test_get_value(self.pointer,
                                                                       FfiConverterOptionString.lower(pingName), $0)
                }
        )
    }
    ...
    public func testGetNumRecordedErrors(_ error: ErrorType, _ pingName: String? = nil) -> Int32 {
        return try! FfiConverterInt32.lift(
            try!
                rustCall {
                    glean_7074_TimingDistributionMetric_test_get_num_recorded_errors(self.pointer,
                                                                                     FfiConverterTypeErrorType.lower(error),
                                                                                     FfiConverterOptionString.lower(pingName), $0)
                }
        )
...
public class MemoryDistributionMetric: MemoryDistributionMetricProtocol {
    ...
    public convenience init(_ meta: CommonMetricData, _ memoryUnit: MemoryUnit) {
        self.init(unsafeFromRawPointer: try!
            ...
            rustCall {
                glean_7074_MemoryDistributionMetric_new(
                    FfiConverterTypeCommonMetricData.lower(meta),
    ...
    deinit {
        try! rustCall { ffi_glean_7074_MemoryDistributionMetric_object_free(pointer, $0) }
    }

    public func accumulate(_ sample: Int64) {
        try!
            rustCall {
                glean_7074_MemoryDistributionMetric_accumulate(self.pointer,
    ...
    public func accumulateSamples(_ samples: [Int64]) {
        try!
            rustCall {
                glean_7074_MemoryDistributionMetric_accumulate_samples(self.pointer,
                                                                       FfiConverterSequenceInt64.lower(samples), $0)
            }
    }
    ...
    public func testGetValue(_ pingName: String? = nil) -> DistributionData? {
        return try! FfiConverterOptionTypeDistributionData.lift(
            try!
                rustCall {
                    glean_7074_MemoryDistributionMetric_test_get_value(self.pointer,
                                                                       FfiConverterOptionString.lower(pingName), $0)
                }
        )
    }
    ...
    public func testGetNumRecordedErrors(_ error: ErrorType, _ pingName: String? = nil) -> Int32 {
        return try! FfiConverterInt32.lift(
            try!
                rustCall {
                    glean_7074_MemoryDistributionMetric_test_get_num_recorded_errors(self.pointer,
                                                                                     FfiConverterTypeErrorType.lower(error),
                                                                                     FfiConverterOptionString.lower(pingName), $0)
                }
        )
...
public class CustomDistributionMetric: CustomDistributionMetricProtocol {
    ...
    public convenience init(_ meta: CommonMetricData, _ rangeMin: Int64, _ rangeMax: Int64, _ bucketCount: Int64, _ histogramType: HistogramType) {
        self.init(unsafeFromRawPointer: try!
            ...
            rustCall {
                glean_7074_CustomDistributionMetric_new(
                    FfiConverterTypeCommonMetricData.lower(meta),
    ...
    deinit {
        try! rustCall { ffi_glean_7074_CustomDistributionMetric_object_free(pointer, $0) }
    }

    public func accumulateSamples(_ samples: [Int64]) {
        try!
            rustCall {
                glean_7074_CustomDistributionMetric_accumulate_samples(self.pointer,
                                                                       FfiConverterSequenceInt64.lower(samples), $0)
            }
    }
    ...
    public func testGetValue(_ pingName: String? = nil) -> DistributionData? {
        return try! FfiConverterOptionTypeDistributionData.lift(
            try!
                rustCall {
                    glean_7074_CustomDistributionMetric_test_get_value(self.pointer,
                                                                       FfiConverterOptionString.lower(pingName), $0)
                }
        )
    }
    ...
    public func testGetNumRecordedErrors(_ error: ErrorType, _ pingName: String? = nil) -> Int32 {
        return try! FfiConverterInt32.lift(
            try!
                rustCall {
                    glean_7074_CustomDistributionMetric_test_get_num_recorded_errors(self.pointer,
                                                                                     FfiConverterTypeErrorType.lower(error),
                                                                                     FfiConverterOptionString.lower(pingName), $0)
                }
        )
...
public class DatetimeMetric: DatetimeMetricProtocol {
    ...
    deinit {
        try! rustCall { ffi_glean_7074_DatetimeMetric_object_free(pointer, $0) }
    }

    public func set(_ value: Datetime? = nil) {
        try!
            rustCall {
                glean_7074_DatetimeMetric_set(self.pointer,
    ...
    public func testGetValue(_ pingName: String? = nil) -> Datetime? {
        return try! FfiConverterOptionTypeDatetime.lift(
            try!
                rustCall {
                    glean_7074_DatetimeMetric_test_get_value(self.pointer,
                                                             FfiConverterOptionString.lower(pingName), $0)
                }
        )
    }
    ...
    public func testGetValueAsString(_ pingName: String? = nil) -> String? {
        return try! FfiConverterOptionString.lift(
            try!
                rustCall {
                    glean_7074_DatetimeMetric_test_get_value_as_string(self.pointer,
                                                                       FfiConverterOptionString.lower(pingName), $0)
                }
        )
    }
    ...
    public func testGetNumRecordedErrors(_ error: ErrorType, _ pingName: String? = nil) -> Int32 {
        return try! FfiConverterInt32.lift(
            try!
                rustCall {
                    glean_7074_DatetimeMetric_test_get_num_recorded_errors(self.pointer,
                                                                           FfiConverterTypeErrorType.lower(error),
                                                                           FfiConverterOptionString.lower(pingName), $0)
                }
        )
...
public class EventMetric: EventMetricProtocol {
    ...
    deinit {
        try! rustCall { ffi_glean_7074_EventMetric_object_free(pointer, $0) }
    }

    public func record(_ extra: [String: String]) {
        try!
            rustCall {
                glean_7074_EventMetric_record(self.pointer,
                                              FfiConverterDictionaryStringString.lower(extra), $0)
            }
    }
    ...
    public func testGetValue(_ pingName: String? = nil) -> [RecordedEvent]? {
        return try! FfiConverterOptionSequenceTypeRecordedEvent.lift(
            try!
                rustCall {
                    glean_7074_EventMetric_test_get_value(self.pointer,
                                                          FfiConverterOptionString.lower(pingName), $0)
                }
        )
    }
    ...
    public func testGetNumRecordedErrors(_ error: ErrorType, _ pingName: String? = nil) -> Int32 {
        return try! FfiConverterInt32.lift(
            try!
                rustCall {
                    glean_7074_EventMetric_test_get_num_recorded_errors(self.pointer,
                                                                        FfiConverterTypeErrorType.lower(error),
                                                                        FfiConverterOptionString.lower(pingName), $0)
                }
        )
...
public class RateMetric: RateMetricProtocol {
    ...
    deinit {
        try! rustCall { ffi_glean_7074_RateMetric_object_free(pointer, $0) }
    }

    public func addToNumerator(_ amount: Int32) {
        try!
            rustCall {
                glean_7074_RateMetric_add_to_numerator(self.pointer,
                                                       FfiConverterInt32.lower(amount), $0)
            }
    }
    ...
    public func addToDenominator(_ amount: Int32) {
        try!
            rustCall {
                glean_7074_RateMetric_add_to_denominator(self.pointer,
                                                         FfiConverterInt32.lower(amount), $0)
            }
    }
    ...
    public func testGetValue(_ pingName: String? = nil) -> Rate? {
        return try! FfiConverterOptionTypeRate.lift(
            try!
                rustCall {
                    glean_7074_RateMetric_test_get_value(self.pointer,
                                                         FfiConverterOptionString.lower(pingName), $0)
                }
        )
    }
    ...
    public func testGetNumRecordedErrors(_ error: ErrorType, _ pingName: String? = nil) -> Int32 {
        return try! FfiConverterInt32.lift(
            try!
                rustCall {
                    glean_7074_RateMetric_test_get_num_recorded_errors(self.pointer,
                                                                       FfiConverterTypeErrorType.lower(error),
                                                                       FfiConverterOptionString.lower(pingName), $0)
                }
        )
...
public class DenominatorMetric: DenominatorMetricProtocol {
    ...
    public convenience init(_ meta: CommonMetricData, _ numerators: [CommonMetricData]) {
        self.init(unsafeFromRawPointer: try!
            ...
            rustCall {
                glean_7074_DenominatorMetric_new(
                    FfiConverterTypeCommonMetricData.lower(meta),
    ...
    deinit {
        try! rustCall { ffi_glean_7074_DenominatorMetric_object_free(pointer, $0) }
    }

    public func add(_ amount: Int32) {
        try!
            rustCall {
                glean_7074_DenominatorMetric_add(self.pointer,
                                                 FfiConverterInt32.lower(amount), $0)
            }
    }
    ...
    public func testGetValue(_ pingName: String? = nil) -> Int32? {
        return try! FfiConverterOptionInt32.lift(
            try!
                rustCall {
                    glean_7074_DenominatorMetric_test_get_value(self.pointer,
                                                                FfiConverterOptionString.lower(pingName), $0)
                }
        )
    }
    ...
    public func testGetNumRecordedErrors(_ error: ErrorType, _ pingName: String? = nil) -> Int32 {
        return try! FfiConverterInt32.lift(
            try!
                rustCall {
                    glean_7074_DenominatorMetric_test_get_num_recorded_errors(self.pointer,
                                                                              FfiConverterTypeErrorType.lower(error),
                                                                              FfiConverterOptionString.lower(pingName), $0)
                }
        )
...
public class NumeratorMetric: NumeratorMetricProtocol {
    ...
    public convenience init(_ meta: CommonMetricData) {
        self.init(unsafeFromRawPointer: try!
            ...
            rustCall {
                glean_7074_NumeratorMetric_new(
                    FfiConverterTypeCommonMetricData.lower(meta), $0
                )
            })
    }
    ...
    deinit {
        try! rustCall { ffi_glean_7074_NumeratorMetric_object_free(pointer, $0) }
    }

    public func addToNumerator(_ amount: Int32) {
        try!
            rustCall {
                glean_7074_NumeratorMetric_add_to_numerator(self.pointer,
                                                            FfiConverterInt32.lower(amount), $0)
            }
    }
    ...
    public func testGetValue(_ pingName: String? = nil) -> Rate? {
        return try! FfiConverterOptionTypeRate.lift(
            try!
                rustCall {
                    glean_7074_NumeratorMetric_test_get_value(self.pointer,
                                                              FfiConverterOptionString.lower(pingName), $0)
                }
        )
    }
    ...
    public func testGetNumRecordedErrors(_ error: ErrorType, _ pingName: String? = nil) -> Int32 {
        return try! FfiConverterInt32.lift(
            try!
                rustCall {
                    glean_7074_NumeratorMetric_test_get_num_recorded_errors(self.pointer,
                                                                            FfiConverterTypeErrorType.lower(error),
                                                                            FfiConverterOptionString.lower(pingName), $0)
                }
        )
...
public class TextMetric: TextMetricProtocol {
    ...
    deinit {
        try! rustCall { ffi_glean_7074_TextMetric_object_free(pointer, $0) }
    }

    public func set(_ value: String) {
        try!
            rustCall {
                glean_7074_TextMetric_set(self.pointer,
                                          FfiConverterString.lower(value), $0)
            }
    }
    ...
    public func testGetValue(_ pingName: String? = nil) -> String? {
        return try! FfiConverterOptionString.lift(
            try!
                rustCall {
                    glean_7074_TextMetric_test_get_value(self.pointer,
                                                         FfiConverterOptionString.lower(pingName), $0)
                }
        )
    }
    ...
    public func testGetNumRecordedErrors(_ error: ErrorType, _ pingName: String? = nil) -> Int32 {
        return try! FfiConverterInt32.lift(
            try!
                rustCall {
                    glean_7074_TextMetric_test_get_num_recorded_errors(self.pointer,
                                                                       FfiConverterTypeErrorType.lower(error),
                                                                       FfiConverterOptionString.lower(pingName), $0)
                }
        )
...
private enum FfiConverterCallbackInterfaceOnGleanEvents {
    ...
    private static func initCallback() {
        try! rustCall { (err: UnsafeMutablePointer<RustCallStatus>) in
            ffi_glean_7074_OnGleanEvents_init_callback(foreignCallbackCallbackInterfaceOnGleanEvents, err)
        }
    }
...
// Helper code for BooleanMetric class is found in ObjectTemplate.swift
// Helper code for CounterMetric class is found in ObjectTemplate.swift
// Helper code for CustomDistributionMetric class is found in ObjectTemplate.swift
// Helper code for DatetimeMetric class is found in ObjectTemplate.swift
// Helper code for DenominatorMetric class is found in ObjectTemplate.swift
// Helper code for EventMetric class is found in ObjectTemplate.swift
// Helper code for LabeledBoolean class is found in ObjectTemplate.swift
// Helper code for LabeledCounter class is found in ObjectTemplate.swift
// Helper code for LabeledString class is found in ObjectTemplate.swift
// Helper code for MemoryDistributionMetric class is found in ObjectTemplate.swift
// Helper code for NumeratorMetric class is found in ObjectTemplate.swift
// Helper code for PingType class is found in ObjectTemplate.swift
// Helper code for QuantityMetric class is found in ObjectTemplate.swift
// Helper code for RateMetric class is found in ObjectTemplate.swift
// Helper code for StringListMetric class is found in ObjectTemplate.swift
// Helper code for StringMetric class is found in ObjectTemplate.swift
// Helper code for TextMetric class is found in ObjectTemplate.swift
// Helper code for TimespanMetric class is found in ObjectTemplate.swift
// Helper code for TimingDistributionMetric class is found in ObjectTemplate.swift
// Helper code for UrlMetric class is found in ObjectTemplate.swift
// Helper code for UuidMetric class is found in ObjectTemplate.swift
// Helper code for ClientInfoMetrics record is found in RecordTemplate.swift
// Helper code for CommonMetricData record is found in RecordTemplate.swift
// Helper code for Datetime record is found in RecordTemplate.swift
// Helper code for DistributionData record is found in RecordTemplate.swift
// Helper code for InternalConfiguration record is found in RecordTemplate.swift
// Helper code for PingRequest record is found in RecordTemplate.swift
// Helper code for Rate record is found in RecordTemplate.swift
// Helper code for RecordedEvent record is found in RecordTemplate.swift
// Helper code for RecordedExperiment record is found in RecordTemplate.swift
// Helper code for TimerId record is found in RecordTemplate.swift
// Helper code for ErrorType enum is found in EnumTemplate.swift
// Helper code for HistogramType enum is found in EnumTemplate.swift
// Helper code for Lifetime enum is found in EnumTemplate.swift
// Helper code for MemoryUnit enum is found in EnumTemplate.swift
// Helper code for PingUploadTask enum is found in EnumTemplate.swift
// Helper code for TimeUnit enum is found in EnumTemplate.swift
// Helper code for UploadResult enum is found in EnumTemplate.swift
