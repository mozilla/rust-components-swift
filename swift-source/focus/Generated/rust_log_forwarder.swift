...
private extension RustBuffer {
    ...
    static func from(_ ptr: UnsafeBufferPointer<UInt8>) -> RustBuffer {
        try! rustCall { ffi_rust_log_forwarder_rustbuffer_from_bytes(ForeignBytes(bufferPointer: ptr), $0) }
    }

    // Frees the buffer in place.
    // The buffer must not be used after this is called.
    func deallocate() {
        try! rustCall { ffi_rust_log_forwarder_rustbuffer_free(self, $0) }
    }
}
...
public struct FfiConverterTypeRecord: FfiConverterRustBuffer {
    public static func read(from buf: inout (data: Data, offset: Data.Index)) throws -> Record {
        return try Record(
            level: FfiConverterTypeLevel.read(from: &buf),
    ...
    public static func write(_ value: Record, into buf: inout [UInt8]) {
        FfiConverterTypeLevel.write(value.level, into: &buf)
...
// Declaration and FfiConverters for AppServicesLogger Callback Interface
...
private let foreignCallbackCallbackInterfaceAppServicesLogger: ForeignCallback =
    { (handle: UniFFICallbackHandle, method: Int32, argsData: UnsafePointer<UInt8>, argsLen: Int32, out_buf: UnsafeMutablePointer<RustBuffer>) -> Int32 in

        func invokeLog(_ swiftCallbackInterface: AppServicesLogger, _ argsData: UnsafePointer<UInt8>, _ argsLen: Int32, _: UnsafeMutablePointer<RustBuffer>) throws -> Int32 {
            var reader = createReader(data: Data(bytes: argsData, count: Int(argsLen)))
            func makeCall() throws -> Int32 {
                try swiftCallbackInterface.log(
                    record: FfiConverterTypeRecord.read(from: &reader)
                )
        ...
        case IDX_CALLBACK_FREE:
            FfiConverterCallbackInterfaceAppServicesLogger.drop(handle: handle)
            // Sucessful return
            // See docs of ForeignCallback in `uniffi_core/src/ffi/foreigncallbacks.rs`
            return UNIFFI_CALLBACK_SUCCESS
        case 1:
            let cb: AppServicesLogger
            do {
                cb = try FfiConverterCallbackInterfaceAppServicesLogger.lift(handle)
            } catch {
                out_buf.pointee = FfiConverterString.lower("AppServicesLogger: Invalid handle")
...
private enum FfiConverterCallbackInterfaceAppServicesLogger {
    private static let initCallbackOnce: () = {
        // Swift ensures this initializer code will once run once, even when accessed by multiple threads.
        try! rustCall { (err: UnsafeMutablePointer<RustCallStatus>) in
            uniffi_rust_log_forwarder_fn_init_callback_appserviceslogger(foreignCallbackCallbackInterfaceAppServicesLogger, err)
        }
    }()
    ...
    private static var handleMap = UniFFICallbackHandleMap<AppServicesLogger>()
}

extension FfiConverterCallbackInterfaceAppServicesLogger: FfiConverter {
    typealias SwiftType = AppServicesLogger
...
private struct FfiConverterOptionCallbackInterfaceAppServicesLogger: FfiConverterRustBuffer {
    typealias SwiftType = AppServicesLogger?
    ...
    public static func write(_ value: SwiftType, into buf: inout [UInt8]) {
        ...
        writeInt(&buf, Int8(1))
        FfiConverterCallbackInterfaceAppServicesLogger.write(value, into: &buf)
    }

    public static func read(from buf: inout (data: Data, offset: Data.Index)) throws -> SwiftType {
        switch try readInt(&buf) as Int8 {
        case 0: return nil
        case 1: return try FfiConverterCallbackInterfaceAppServicesLogger.read(from: &buf)
