...
public struct FfiConverterTypeRemoteSettingsContext: FfiConverterRustBuffer {
    public static func read(from buf: inout (data: Data, offset: Data.Index)) throws -> RemoteSettingsContext {
        return
            try RemoteSettingsContext(
                ...
                customTargetingAttributes: FfiConverterOptionTypeRsJsonObject.read(from: &buf)
        )
    }
    ...
    public static func write(_ value: RemoteSettingsContext, into buf: inout [UInt8]) {
        ...
        FfiConverterOptionTypeRsJsonObject.write(value.customTargetingAttributes, into: &buf)
    }
}
...
@_documentation(visibility: private)
#endif
fileprivate struct FfiConverterOptionTypeRsJsonObject: FfiConverterRustBuffer {
    typealias SwiftType = RsJsonObject?
    ...
    public static func write(_ value: SwiftType, into buf: inout [UInt8]) {
        ...
        writeInt(&buf, Int8(1))
        FfiConverterTypeRsJsonObject.write(value, into: &buf)
    }

    public static func read(from buf: inout (data: Data, offset: Data.Index)) throws -> SwiftType {
        switch try readInt(&buf) as Int8 {
        case 0: return nil
        case 1: return try FfiConverterTypeRsJsonObject.read(from: &buf)
        default: throw UniffiInternalError.unexpectedOptionalTag
        }
    }
}
