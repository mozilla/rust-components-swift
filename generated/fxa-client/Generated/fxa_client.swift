...
private extension RustBuffer {
    ...
    static func from(_ ptr: UnsafeBufferPointer<UInt8>) -> RustBuffer {
        try! rustCall { ffi_fxa_client_9b3e_rustbuffer_from_bytes(ForeignBytes(bufferPointer: ptr), $0) }
    }

    // Frees the buffer in place.
    // The buffer must not be used after this is called.
    func deallocate() {
        try! rustCall { ffi_fxa_client_9b3e_rustbuffer_free(self, $0) }
    }
}
...
public class FirefoxAccount: FirefoxAccountProtocol {
    ...
    public convenience init(contentUrl: String, clientId: String, redirectUri: String, tokenServerUrlOverride: String?) {
        self.init(unsafeFromRawPointer: try!
            ...
            rustCall {
                fxa_client_9b3e_FirefoxAccount_new(contentUrl.lower(), clientId.lower(), redirectUri.lower(), FfiConverterOptionString.lower(tokenServerUrlOverride), $0)
            })
    }

    deinit {
        try! rustCall { ffi_fxa_client_9b3e_FirefoxAccount_object_free(pointer, $0) }
    }
    ...
    public static func fromJson(data: String) throws -> FirefoxAccount {
        return FirefoxAccount(unsafeFromRawPointer: try
            ...
            rustCallWithError(FxaError.self) {
                fxa_client_9b3e_FirefoxAccount_from_json(data.lower(), $0)
            })
    }
    ...
    public func toJson() throws -> String {
        let _retval = try
            rustCallWithError(FxaError.self) {
                fxa_client_9b3e_FirefoxAccount_to_json(self.pointer, $0)
            }
    ...
    public func beginOauthFlow(scopes: [String], entrypoint: String, metrics: MetricsParams?) throws -> String {
        let _retval = try
            rustCallWithError(FxaError.self) {
                fxa_client_9b3e_FirefoxAccount_begin_oauth_flow(self.pointer, FfiConverterSequenceString.lower(scopes), entrypoint.lower(), FfiConverterOptionRecordMetricsParams.lower(metrics), $0)
            }
        return try String.lift(_retval)
    }
    ...
    public func getPairingAuthorityUrl() throws -> String {
        let _retval = try
            rustCallWithError(FxaError.self) {
                fxa_client_9b3e_FirefoxAccount_get_pairing_authority_url(self.pointer, $0)
            }
        return try String.lift(_retval)
    }
    ...
    public func beginPairingFlow(pairingUrl: String, scopes: [String], entrypoint: String, metrics: MetricsParams?) throws -> String {
        let _retval = try
            rustCallWithError(FxaError.self) {
                fxa_client_9b3e_FirefoxAccount_begin_pairing_flow(self.pointer, pairingUrl.lower(), FfiConverterSequenceString.lower(scopes), entrypoint.lower(), FfiConverterOptionRecordMetricsParams.lower(metrics), $0)
            }
        return try String.lift(_retval)
    }
    ...
    public func completeOauthFlow(code: String, state: String) throws {
        try
            rustCallWithError(FxaError.self) {
                fxa_client_9b3e_FirefoxAccount_complete_oauth_flow(self.pointer, code.lower(), state.lower(), $0)
            }
    }
    ...
    public func checkAuthorizationStatus() throws -> AuthorizationInfo {
        let _retval = try
            rustCallWithError(FxaError.self) {
                fxa_client_9b3e_FirefoxAccount_check_authorization_status(self.pointer, $0)
            }
    ...
    public func disconnect() {
        try!
            rustCall {
                fxa_client_9b3e_FirefoxAccount_disconnect(self.pointer, $0)
            }
    }
    ...
    public func getProfile(ignoreCache: Bool) throws -> Profile {
        let _retval = try
            rustCallWithError(FxaError.self) {
                fxa_client_9b3e_FirefoxAccount_get_profile(self.pointer, ignoreCache.lower(), $0)
            }
    ...
    public func initializeDevice(name: String, deviceType: DeviceType, supportedCapabilities: [DeviceCapability]) throws {
        try
            rustCallWithError(FxaError.self) {
                fxa_client_9b3e_FirefoxAccount_initialize_device(self.pointer, name.lower(), deviceType.lower(), FfiConverterSequenceEnumDeviceCapability.lower(supportedCapabilities), $0)
            }
    }
    ...
    public func getCurrentDeviceId() throws -> String {
        let _retval = try
            rustCallWithError(FxaError.self) {
                fxa_client_9b3e_FirefoxAccount_get_current_device_id(self.pointer, $0)
            }
        return try String.lift(_retval)
    }
    ...
    public func getDevices(ignoreCache: Bool) throws -> [Device] {
        let _retval = try
            rustCallWithError(FxaError.self) {
                fxa_client_9b3e_FirefoxAccount_get_devices(self.pointer, ignoreCache.lower(), $0)
            }
    ...
    public func getAttachedClients() throws -> [AttachedClient] {
        let _retval = try
            rustCallWithError(FxaError.self) {
                fxa_client_9b3e_FirefoxAccount_get_attached_clients(self.pointer, $0)
            }
    ...
    public func setDeviceName(displayName: String) throws {
        try
            rustCallWithError(FxaError.self) {
                fxa_client_9b3e_FirefoxAccount_set_device_name(self.pointer, displayName.lower(), $0)
            }
    }
    ...
    public func clearDeviceName() throws {
        try
            rustCallWithError(FxaError.self) {
                fxa_client_9b3e_FirefoxAccount_clear_device_name(self.pointer, $0)
            }
    }
    ...
    public func ensureCapabilities(supportedCapabilities: [DeviceCapability]) throws {
        try
            rustCallWithError(FxaError.self) {
                fxa_client_9b3e_FirefoxAccount_ensure_capabilities(self.pointer, FfiConverterSequenceEnumDeviceCapability.lower(supportedCapabilities), $0)
            }
    }
    ...
    public func setPushSubscription(subscription: DevicePushSubscription) throws {
        try
            rustCallWithError(FxaError.self) {
                fxa_client_9b3e_FirefoxAccount_set_push_subscription(self.pointer, subscription.lower(), $0)
            }
    }
    ...
    public func handlePushMessage(payload: String) throws -> [AccountEvent] {
        let _retval = try
            rustCallWithError(FxaError.self) {
                fxa_client_9b3e_FirefoxAccount_handle_push_message(self.pointer, payload.lower(), $0)
            }
    ...
    public func pollDeviceCommands() throws -> [IncomingDeviceCommand] {
        let _retval = try
            rustCallWithError(FxaError.self) {
                fxa_client_9b3e_FirefoxAccount_poll_device_commands(self.pointer, $0)
            }
    ...
    public func sendSingleTab(targetDeviceId: String, title: String, url: String) throws {
        try
            rustCallWithError(FxaError.self) {
                fxa_client_9b3e_FirefoxAccount_send_single_tab(self.pointer, targetDeviceId.lower(), title.lower(), url.lower(), $0)
            }
    }
    ...
    public func getTokenServerEndpointUrl() throws -> String {
        let _retval = try
            rustCallWithError(FxaError.self) {
                fxa_client_9b3e_FirefoxAccount_get_token_server_endpoint_url(self.pointer, $0)
            }
        return try String.lift(_retval)
    }
    ...
    public func getConnectionSuccessUrl() throws -> String {
        let _retval = try
            rustCallWithError(FxaError.self) {
                fxa_client_9b3e_FirefoxAccount_get_connection_success_url(self.pointer, $0)
            }
        return try String.lift(_retval)
    }
    ...
    public func getManageAccountUrl(entrypoint: String) throws -> String {
        let _retval = try
            rustCallWithError(FxaError.self) {
                fxa_client_9b3e_FirefoxAccount_get_manage_account_url(self.pointer, entrypoint.lower(), $0)
            }
        return try String.lift(_retval)
    }
    ...
    public func getManageDevicesUrl(entrypoint: String) throws -> String {
        let _retval = try
            rustCallWithError(FxaError.self) {
                fxa_client_9b3e_FirefoxAccount_get_manage_devices_url(self.pointer, entrypoint.lower(), $0)
            }
        return try String.lift(_retval)
    }
    ...
    public func getAccessToken(scope: String, ttl: Int64?) throws -> AccessTokenInfo {
        let _retval = try
            rustCallWithError(FxaError.self) {
                fxa_client_9b3e_FirefoxAccount_get_access_token(self.pointer, scope.lower(), FfiConverterOptionInt64.lower(ttl), $0)
            }
    ...
    public func getSessionToken() throws -> String {
        let _retval = try
            rustCallWithError(FxaError.self) {
                fxa_client_9b3e_FirefoxAccount_get_session_token(self.pointer, $0)
            }
        return try String.lift(_retval)
    }
    ...
    public func handleSessionTokenChange(sessionToken: String) throws {
        try
            rustCallWithError(FxaError.self) {
                fxa_client_9b3e_FirefoxAccount_handle_session_token_change(self.pointer, sessionToken.lower(), $0)
            }
    }
    ...
    public func authorizeCodeUsingSessionToken(params: AuthorizationParameters) throws -> String {
        let _retval = try
            rustCallWithError(FxaError.self) {
                fxa_client_9b3e_FirefoxAccount_authorize_code_using_session_token(self.pointer, params.lower(), $0)
            }
        return try String.lift(_retval)
    }
    ...
    public func clearAccessTokenCache() {
        try!
            rustCall {
                fxa_client_9b3e_FirefoxAccount_clear_access_token_cache(self.pointer, $0)
            }
    }
    ...
    public func gatherTelemetry() throws -> String {
        let _retval = try
            rustCallWithError(FxaError.self) {
                fxa_client_9b3e_FirefoxAccount_gather_telemetry(self.pointer, $0)
            }
        return try String.lift(_retval)
    }
    ...
    public func migrateFromSessionToken(sessionToken: String, kSync: String, kXcs: String, copySessionToken: Bool) throws -> FxAMigrationResult {
        let _retval = try
            rustCallWithError(FxaError.self) {
                fxa_client_9b3e_FirefoxAccount_migrate_from_session_token(self.pointer, sessionToken.lower(), kSync.lower(), kXcs.lower(), copySessionToken.lower(), $0)
            }
    ...
    public func retryMigrateFromSessionToken() throws -> FxAMigrationResult {
        let _retval = try
            rustCallWithError(FxaError.self) {
                fxa_client_9b3e_FirefoxAccount_retry_migrate_from_session_token(self.pointer, $0)
            }
        return try FxAMigrationResult.lift(_retval)
    }
    ...
    public func isInMigrationState() -> MigrationState {
        let _retval = try!
            rustCall {
                fxa_client_9b3e_FirefoxAccount_is_in_migration_state(self.pointer, $0)
            }
