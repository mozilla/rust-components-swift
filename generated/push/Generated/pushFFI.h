...
void ffi_push_9ca4_PushManager_object_free(
      void*_Nonnull ptr,
    RustCallStatus *_Nonnull out_status
    );
void*_Nonnull push_9ca4_PushManager_new(
...
RustBuffer push_9ca4_PushManager_subscribe(
      void*_Nonnull ptr,RustBuffer channel_id,RustBuffer scope,RustBuffer app_server_sey,
    RustCallStatus *_Nonnull out_status
    );
int8_t push_9ca4_PushManager_unsubscribe(
      void*_Nonnull ptr,RustBuffer channel_id,
    RustCallStatus *_Nonnull out_status
    );
void push_9ca4_PushManager_unsubscribe_all(
      void*_Nonnull ptr,
    RustCallStatus *_Nonnull out_status
    );
int8_t push_9ca4_PushManager_update(
      void*_Nonnull ptr,RustBuffer registration_token,
    RustCallStatus *_Nonnull out_status
    );
RustBuffer push_9ca4_PushManager_verify_connection(
      void*_Nonnull ptr,
    RustCallStatus *_Nonnull out_status
    );
RustBuffer push_9ca4_PushManager_decrypt(
      void*_Nonnull ptr,RustBuffer channel_id,RustBuffer body,RustBuffer encoding,RustBuffer salt,RustBuffer dh,
    RustCallStatus *_Nonnull out_status
    );
RustBuffer push_9ca4_PushManager_dispatch_info_for_chid(
      void*_Nonnull ptr,RustBuffer channel_id,
    RustCallStatus *_Nonnull out_status
    );
RustBuffer ffi_push_9ca4_rustbuffer_alloc(
      int32_t size,
    RustCallStatus *_Nonnull out_status
    );
RustBuffer ffi_push_9ca4_rustbuffer_from_bytes(
      ForeignBytes bytes,
    RustCallStatus *_Nonnull out_status
    );
void ffi_push_9ca4_rustbuffer_free(
      RustBuffer buf,
    RustCallStatus *_Nonnull out_status
    );
RustBuffer ffi_push_9ca4_rustbuffer_reserve(
